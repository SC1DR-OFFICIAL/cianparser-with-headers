...
> ⚠️ Этот проект является **форком оригинального репозитория [https://github.com/lenarsaitov/cianparser](https://github.com/lenarsaitov/cianparser)**.  
...
> }
> ```
> но можно передать свои через параметр `headers` в класс `CianParser`.
